// import {VersionScheme} from 'nx/release';
...
import {
  ...
  normalizeVersionPattern, VersionPatternOptions
} from './version-actions-options';
import { interpolateVersionPattern } from './version-pattern-utils';

type VersionPatternOptionsKeys = keyof VersionPatternOptions;
...
export default class DockerVersionActions extends VersionActions {
  ...
  override async calculateNewVersion(
    currentVersion: string | null,
    ...
    let newVersion = [
      ...
      ? this.versionPatterns[newVersionInput as VersionPatternOptionsKeys] || this.defaultVersionPattern
      : newVersionInput;
